...
export const metadata = {
  title: "观潮周报 · 每周市场情报",
  description: "每周五晚由 GPT-5.6 Terra 汇总本周大事、高价值洞察与三地市场资金路径。",
};
    ...
    <div className="weekly-shell">
      ...
      <main className="weekly-index-page">
        <section className="weekly-index-hero">
          ...
          <h1>观潮周报</h1>
          <p>每周五20:00，以最新完整交易日为边界，汇总政策、A股、港股、美股、跨市场主线及本地日报沉淀。</p>
          <div><span><Sparkles size={15} /> GPT-5.6 Terra 深度整理</span><span><Clock3 size={15} /> 北京时间每周五20:00</span><NoticePreferences /></div>
        </section>
        {index.reports.length ? (
          ...
          <section className="weekly-empty"><CalendarRange size={28} /><span>FIRST EDITION PENDING</span><h2>首期周报将在本周五晚生成</h2><p>当前页面和自动化流程已经就绪。周五20:00发布后，首次打开网站会出现更新摘要弹窗。</p></section>
        )}
      </main>
